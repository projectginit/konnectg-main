      ...
      <main className="mx-auto max-w-6xl px-6 py-12">
        ...
        <div className="grid grid-cols-2 gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {CATEGORIES.map((cat) => (
            <div
              key={cat.name}
              className="group flex cursor-pointer flex-col rounded-2xl border border-[#F0EEF6] bg-white p-6 shadow-sm transition-all duration-200 hover:-translate-y-1 hover:shadow-xl hover:shadow-purple-100"
            >
              {/* Icon */}
              <div
